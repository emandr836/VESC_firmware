...
//#define HW_EARLY_INIT()			palSetPadMode(HW_SHUTDOWN_GPIO, HW_SHUTDOWN_PIN, PAL_MODE_OUTPUT_PUSHPULL);	HW_SHUTDOWN_HOLD_ON();
...
#define MCCONF_L_IN_CURRENT_MAX			8.0		// Input current limit in Amperes (Upper)
#endif
...
// Setting limits
#define HW_LIM_CURRENT			-30.0, 30.0		//phase amps
#define HW_LIM_CURRENT_IN		-3.0, 10.0		//battery amps
#define HW_LIM_CURRENT_ABS		-32.0, 32.0		//abs phase amps
#define HW_LIM_VIN				11.0, 60.0
